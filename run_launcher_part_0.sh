...
export RUN_NAME="wy2022_r52184_new_stations" # name of the run (this will be name of *.mdu file and folder it's stored in)
...
export SFB_DFM_PARENT_PATH=/boisevol1/hpcshared/open_bay/hydro/full_res/wy2022_r52184     # this is the directory where the sfb_dfm and stompy are located, and it is where the "runs" folder will be created
...
# these are the paths if the code is old (r52814)
...
# these are the paths if the code is newer
