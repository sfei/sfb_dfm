...
export RUN_STOP="2023-10-01"   # run end time in YYYY-MM-DD format
export MAKE_PLOTS="True"       # flag to make and save plots of boundary conditions
export SFB_DFM_PARENT_PATH=/fortcollinsvol2/hpcshared/open_bay/hydro/full_res/wy2023-v24/     # this is the directory where the sfb_dfm and stompy are located, and it is where the "runs" folder will be created
