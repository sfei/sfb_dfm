...
export RUN_NAME="wy2021-v24" # name of the run (this will be name of *.mdu file and folder it's stored in)
...
export SFB_DFM_PARENT_PATH=/boisevol2/hpcshared/open_bay/hydro/full_res/wy2021-v24/     # this is the directory where the sfb_dfm and stompy are located, and it is where the "runs" folder will be created
...
# used to use an older python environment, currently
# just using base environment on sfei servers
